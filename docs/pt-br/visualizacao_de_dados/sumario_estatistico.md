...
**7.** Assimetria
	...
	![Tipos de Simetria](/vuepress/img/visualizacao_de_dados/sumario_estatistico/image2.png)
...
**8.** Curtose:\
	...
	![Curtose](/vuepress/img/visualizacao_de_dados/sumario_estatistico/image4.png)\
	Fonte: <https://www.biologyforlife.com/standard-deviation.html> \
	![Tipos de Curtose](/vuepress/img/visualizacao_de_dados/sumario_estatistico/image3.png)\
...
![Ler dados](/vuepress/img/visualizacao_de_dados/sumario_estatistico/image1.png)

1. Adicione uma base de dados por meio da operação [Ler dados][4]. 

2. Adicione a operação **Sumário Estatístico** e não preencha nenhum atributo. Preencha o título com *"Sumário"*
	
	![Sumario Estatístico](/vuepress/img/visualizacao_de_dados/sumario_estatistico/image6.png)

3. Observe o resultado final após cada execução do fluxo;
	
	![Resultados](/vuepress/img/visualizacao_de_dados/sumario_estatistico/image5.png)
-----
