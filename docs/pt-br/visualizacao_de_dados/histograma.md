...
![Ler dados](/vuepress/img/visualizacao_de_dados/histograma/image1.png)

**1.** Adicione uma base de dados por meio da operação [Ler dados][4].
	![Formulario Ler Dados](/vuepress/img/visualizacao_de_dados/histograma/image2.png)
...
**2.**  Adicione a operação **Histograma** e preencha o campo **Título**. Selecione *“petallength”*  no campo **Atributos de entrada** e preencha o valor *“'5*” no campo **Quantidade de intervalos**. \
	![Formulario](/vuepress/img/visualizacao_de_dados/histograma/image3.png)

**3.** Execute o fluxo e visualize o resultado. \
	![Execução](/vuepress/img/visualizacao_de_dados/histograma/image4.png)
